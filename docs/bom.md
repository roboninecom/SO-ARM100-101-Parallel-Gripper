...
| | Bus Servo Adapter Board | 1 | ~$11.00 | [Waveshare](https://www.waveshare.com/bus-servo-adapter-a.htm) |
...
|-------------|-------------|:---:|------------|
| RB9.01.062.010 | Main frame | 1 | ~$5.00 |
| RB9.01.062.020 | Clamp | 2 | ~$3.00 |
| RB9.01.062.030 | Gear rack | 2 | ~$1.00 |
| RB9.01.062.040 | Gear | 1 | ~$0.50 |
| RB9.01.060.074 | Camera holder | 1 | ~$2.00 |
| RB9.01.060.080 | Holder | 1 | ~$1.00 |
| RB9.01.060.090 | Camera Spacer | 1 | ~$0.50 |

*3D printing estimates based on ~$0.05/g PLA filament + electricity costs*

## Histology Slide Workflow Add-ons

These items are specific to the community histology slide gripper mod's microscope slide and staining dipper/rack workflow and are not included in the follower gripper cost total.
...
| Parallel microscope slide gripper assembly | Mod-specific printable assembly for slide and rack handling | 1 | Print cost | [STL/STEP files](../models/histology-slide-gripper/) |
...
| | Screw DIN 912 M2x8 | 2 | ~$6.79 (120pcs) | [Amazon](https://www.amazon.com/TOP-VIGOR-Stainless-Replacement-Motorcycle-Repairment/dp/B0D5CHC6GR) |
| | Nut DIN 934 M2 | 4 | ~$5.99 (100pcs) | [Amazon](https://www.amazon.com/QXSKSLH-Metric-Stainless-Hex-Nuts-100pcs/dp/B0CSWRN19Q) |
...
| Bearings | MF106ZZ (2) | ~$2.00* |
| Rods | D6x125 (2) | ~$1.00* |
| 3D-Printed Parts | 8 parts | ~$12.00 |
...
- **Prices** are approximate and based on Amazon/supplier listings as of January 2026
- **Bulk savings**: Fasteners and bearings come in packs, providing extras for future builds
- **3D printing costs** assume home printing with PLA (~200-300g total material)
- **Shipping** not included in estimates
- Consider ordering from single suppliers to reduce shipping costs
